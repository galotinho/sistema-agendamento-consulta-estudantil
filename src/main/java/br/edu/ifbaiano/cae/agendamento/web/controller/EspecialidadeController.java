...
public class EspecialidadeController {
	...
	public ResponseEntity<?> getEspecialidades(HttpServletRequest http){
		return ResponseEntity.ok(service.buscarEspecialidades(http));
	}
	...
	@GetMapping("/datatables/server/profissional/{id}")
	public ResponseEntity<?> getEspecialidadesPorMedico(@PathVariable("id") Long id, HttpServletRequest http){
		
		return ResponseEntity.ok(service.buscarEspecialidadesPorMedico(id, http));
	}
