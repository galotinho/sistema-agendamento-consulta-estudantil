...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 .antMatchers("/profissionais/especialidade/titulo/*", "/profissionais/horarios/hora/disponivel/*/*", "/profissionais/horarios/data/disponivel/*").hasAnyAuthority(PACIENTE, PROFISSIONAL)
